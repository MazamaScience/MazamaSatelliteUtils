...
A time series plot with only 12 points doesn't provide as much insight as one
that covers a whole day. We are currently building a function that can create
a raster stack for given date between sunrise and sunset, and plotting this
gives a much clearer view on the trend of AOD than a single hour does:

![](~/Desktop/aod_ts_day.png)
