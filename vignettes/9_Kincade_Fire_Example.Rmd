...
```
goesaodc_listDaytimeFiles(satID = "G17", datetime = "2019-10-29", timezone = "America/Los_Angeles", useRemote = TRUE)
...
goesaodc_downloadDaytimeAOD(satID = "G17", datetime = "2019-10-29", timezone = "America/Los_Angeles", verbose = TRUE)
...
```
goesaodc_listDaytimeFiles(satID = "G17", datetime = "2019-10-29", timezone = "America/Los_Angeles")
<snip>
[140] "OR_ABI-L2-AODC-M6_G17_s20193030136196_e20193030138569_c20193030141011.nc"
[141] "OR_ABI-L2-AODC-M6_G17_s20193030141196_e20193030143569_c20193030145552.nc"
[142] "OR_ABI-L2-AODC-M6_G17_s20193030146196_e20193030148569_c20193030151118.nc"
...
```{r first_view, message=FALSE, fig.align='center', fig.asp=.987}
installGoesGrids()
...
```
<center>
__2019-10-29 10:00AM PDT AOD Image__
</center>
  
We can clearly see the heavy smoke plume coming out towards the Southwest, as well as dense smoke that is drifting throughout the rest of the Bay Area.
