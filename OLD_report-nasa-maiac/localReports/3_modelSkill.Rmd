...
knitr::opts_chunk$set(echo = FALSE, fig.path = 'modelSkill_figures/', fig.keep = 'high')
# Load packages
...
```{r loadingMonitoringData, include = FALSE}
...
# Create logical vectors for each threshold
...
# Fit logistic regressions for each threshold and calculate where p = .5
...
# Pull out some data about each model
